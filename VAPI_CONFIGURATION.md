...
- **Request URL:** `https://service-hub-258.preview.emergentagent.com/api/v1/vapi/create-lead`
- **Request Method:** POST
...
- **Request URL:** `https://service-hub-258.preview.emergentagent.com/api/v1/vapi/check-availability`
- **Request Method:** POST
- **Content-Type Header:** `application/json`
...
- **Request URL:** `https://service-hub-258.preview.emergentagent.com/api/v1/vapi/book-job`
- **Request Method:** POST
- **Content-Type Header:** `application/json`
...
- **Request URL:** `https://service-hub-258.preview.emergentagent.com/api/v1/vapi/send-sms`
- **Request Method:** POST
- **Content-Type Header:** `application/json`
...
- **Request URL:** `https://service-hub-258.preview.emergentagent.com/api/v1/vapi/call-summary`
- **Request Method:** POST
- **Content-Type Header:** `application/json`
...
`https://service-hub-258.preview.emergentagent.com/api/v1/sms/inbound`
