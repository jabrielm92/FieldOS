...
**Backend Base URL:** `https://voice-receptionist-4.preview.emergentagent.com`
...
| Tool | URL |
|------|-----|
| **Create Lead** | `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/create-lead` |
| **Check Availability** | `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/check-availability` |
| **Book Job** | `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/book-job` |
| **Send SMS** | `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/send-sms` |
| **Log Call Summary** | `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/call-summary` |
| **Twilio Inbound SMS Webhook** | `https://voice-receptionist-4.preview.emergentagent.com/api/v1/sms/inbound` |
...
**URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/create-lead`  
**Method:** POST  
...
**URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/check-availability`  
**Method:** POST  
**Content-Type:** application/json
...
**URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/book-job`  
**Method:** POST  
**Content-Type:** application/json
...
**URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/send-sms`  
**Method:** POST  
**Content-Type:** application/json
...
**URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/call-summary`  
**Method:** POST  
**Content-Type:** application/json
...
**URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/sms/inbound`  
**Method:** POST  
...
4. Under **A MESSAGE COMES IN**, set:
   - **Webhook URL:** `https://voice-receptionist-4.preview.emergentagent.com/api/v1/sms/inbound`
   - **HTTP Method:** POST
...
```bash
# Test create-lead
curl -X POST "https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/create-lead" \
...
curl -X POST "https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/check-availability" \
  -H "Content-Type: application/json" \
  -H "x-vapi-secret: service-hub-258" \
  -d '{"tenant_slug": "radiance-hvac", "date": "2025-12-20"}'

# Test book-job (use IDs from create-lead and windows from check-availability)
curl -X POST "https://voice-receptionist-4.preview.emergentagent.com/api/v1/vapi/book-job" \
  -H "Content-Type: application/json" \
  -H "x-vapi-secret: service-hub-258" \
  -d '{
    "tenant_slug": "radiance-hvac",
